...
categories_encoded = mlb.fit_transform(df['supported_languages'])
prefixed_columns = [f"lang_{c}" for c in mlb.classes_]
...
for name, pipeline in pipelines.items():
    ...
    plt.title('Top 20 Feature Importances with Languages')
    plt.savefig('feature_imp_lang.png')
