...
categories_encoded = mlb.fit_transform(df['genres'])
prefixed_columns = [f"genre_{c}" for c in mlb.classes_]
...
for name, pipeline in pipelines.items():
    ...
    plt.title('Top 20 Feature Importances with Genres')
    plt.savefig('feature_imp_genre.png')
