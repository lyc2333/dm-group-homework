...
categories_encoded = mlb.fit_transform(df['tags'])
prefixed_columns = [f"tag_{c}" for c in mlb.classes_]
...
for name, pipeline in pipelines.items():
    ...
    plt.title('Top 20 Feature Importances with Tags')
    plt.savefig('feature_imp_tag.png')
